...
const model_type = "gpt-4"; // gpt-3.5-turbo
...
var system_setup_message = `
		...
		You are a kind and friendly assistant. 
		You are able to answer questions about students in a database. 
		You can read from a database but you cannot change the data in the database.
		You need a password from the user before you can load the data.
		When you load the data, don't display the contents to the user. Instead
		wait until the user asks questions about the data.
		`;
		...
		const tools = [
		  {
		    ...
		    function: {
		      name: "getStudentInfo",
		      description: "Given a password as input, his function returns a dictionary containing the full name and date of birth of all students in a database.",
